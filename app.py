...
MEMORY_TURNS         = 3      # how many past Q&A pairs to include in the LLM prompt
MAX_RETRIES          = 2      # validation retry attempts before returning best effort
DB_STRONG_THRESHOLD  = 3      # min DB chunks needed to skip web search
SCORE_THRESHOLD      = 0.60   # min Pinecone score to count a chunk as "strong"
...
def handle_conversational(user_query: str) -> str:
    ...
    """
    prompt = f"""You are a helpful internal company assistant for sales representatives and employees.
